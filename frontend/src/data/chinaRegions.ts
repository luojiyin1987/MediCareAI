...
// 内蒙古自治区
export const neimenggu: Province = {
  code: "150000",
  name: "内蒙古自治区",
  cities: [
    {
...
// 黑龙江省
export const heilongjiang: Province = {
  code: "230000",
  name: "黑龙江省",
  cities: [
    {
...
// 上海市
export const shanghai: Province = {
  code: "310000",
  name: "上海市",
  cities: [
    {
...
// 浙江省
export const zhejiang: Province = {
  code: "330000",
  name: "浙江省",
  cities: [
    {
  ...
  cities: [
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "350427", name: "将乐县" },
        { code: "350428", name: "泰宁县" },
        { code: "350429", name: "建宁县" },
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "350622", name: "漳浦县" },
        { code: "350623", name: "云霄县" },
...
// 山东省
export const shandong: Province = {
  code: "370000",
  name: "山东省",
  cities: [
    {
  ...
  cities: [
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "410307", name: "洛龙区" },
        { code: "410308", name: "偃师区" },
        { code: "410311", name: "孟津区" },
  ...
  cities: [
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "420528", name: "长阳县" },
        { code: "420529", name: "五峰县" },
...
// 广东省
export const guangdong: Province = {
  code: "440000",
  name: "广东省",
  cities: [
    {
...
export const hainan: Province = {
  ...
  cities: [
    ...
    },
    {
      ...
      name: "琼中黎族苗族自治县",
      districts: [
        { code: "469026", name: "琼中黎族苗族自治县" }
      ]
    }
  ]
};
// 重庆市
export const chongqing: Province = {
  code: "500000",
  name: "重庆市",
  cities: [
    {
  ...
  cities: [
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "513425", name: "会东县" },
        { code: "513426", name: "宁南县" },
        { code: "513427", name: "普格县" },
        { code: "513428", name: "布拖县" },
        { code: "513429", name: "金阳县" },
        { code: "513430", name: "昭觉县" },
        { code: "513431", name: "喜德县" },
        { code: "513432", name: "冕宁县" },
        { code: "513433", name: "越西县" },
        { code: "513434", name: "甘洛县" },
        { code: "513435", name: "美姑县" },
        { code: "513436", name: "雷波县" }
      ]
    }
  ]
};
// 贵州省
export const guizhou: Province = {
  code: "520000",
  name: "贵州省",
  cities: [
    {
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "520523", name: "黔西市" },
        { code: "520524", name: "金沙县" },
        { code: "520525", name: "织金县" },
        { code: "520526", name: "纳雍县" },
        { code: "520527", name: "威宁彝族回族苗族自治县" },
        { code: "520528", name: "赫章县" }
      ]
    },
    {
      code: "520600",
  ...
  cities: [
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "610929", name: "旬阳市" },
        { code: "610981", name: "白河县" }
      ]
    },
    {
      code: "611000",
...
// 新疆维吾尔自治区
export const xinjiang: Province = {
  code: "650000",
  name: "新疆维吾尔自治区",
  cities: [
    {
  ...
  cities: [
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "710242", name: "仁武区" },
        { code: "710243", name: "大社区" },
        { code: "710244", name: "冈山区" },
        { code: "710245", name: "路竹区" },
        { code: "710246", name: "阿莲区" },
        { code: "710247", name: "田寮区" },
        { code: "710248", name: "燕巢区" },
        { code: "710249", name: "桥头区" },
        { code: "710250", name: "梓官区" },
        { code: "710251", name: "弥陀区" },
        { code: "710252", name: "永安区" },
        { code: "710253", name: "湖内区" },
        { code: "710254", name: "凤山区" },
        { code: "710255", name: "大寮区" },
        { code: "710256", name: "林园区" },
        { code: "710257", name: "鸟松区" },
        { code: "710258", name: "大树区" },
        { code: "710259", name: "旗山区" },
        { code: "710260", name: "美浓区" },
        { code: "710261", name: "六龟区" },
        { code: "710262", name: "内门区" },
        { code: "710263", name: "杉林区" },
        { code: "710264", name: "甲仙区" },
        { code: "710265", name: "桃源区" },
        { code: "710266", name: "那玛夏区" },
        { code: "710267", name: "茂林区" },
        { code: "710268", name: "茄萣区" }
      ]
    },
    {
      code: "710300",
      ...
      districts: [
        ...
        { code: "710339", name: "永康区" },
        { code: "710340", name: "归仁区" },
        { code: "710341", name: "新化区" },
        { code: "710342", name: "左镇区" },
        { code: "710343", name: "玉井区" },
        { code: "710344", name: "楠西区" },
        { code: "710345", name: "南化区" },
        { code: "710346", name: "仁德区" },
        { code: "710347", name: "关庙区" },
        { code: "710348", name: "龙崎区" },
        { code: "710349", name: "官田区" },
        { code: "710350", name: "麻豆区" },
        { code: "710351", name: "佳里区" },
        { code: "710352", name: "西港区" },
        { code: "710353", name: "七股区" },
        { code: "710354", name: "将军区" },
        { code: "710355", name: "学甲区" },
        { code: "710356", name: "北门区" },
        { code: "710357", name: "新营区" },
        { code: "710358", name: "后壁区" },
        { code: "710359", name: "白河区" },
        { code: "710360", name: "东山区" },
        { code: "710361", name: "六甲区" },
        { code: "710362", name: "下营区" },
        { code: "710363", name: "柳营区" },
        { code: "710364", name: "盐水区" },
        { code: "710365", name: "善化区" },
        { code: "710366", name: "大内区" },
        { code: "710367", name: "山上区" },
        { code: "710368", name: "新市区" },
        { code: "710369", name: "安定区" }
      ]
    },
    {
      code: "710400",
      ...
      districts: [
        ...
        { code: "710431", name: "太平区" },
        { code: "710432", name: "大里区" },
        { code: "710433", name: "雾峰区" },
        { code: "710434", name: "乌日区" },
        { code: "710435", name: "丰原区" },
        { code: "710436", name: "后里区" },
        { code: "710437", name: "石冈区" },
        { code: "710438", name: "东势区" },
        { code: "710439", name: "和平区" },
        { code: "710440", name: "新社区" },
        { code: "710441", name: "潭子区" },
        { code: "710442", name: "大雅区" },
        { code: "710443", name: "神冈区" },
        { code: "710444", name: "大肚区" },
        { code: "710445", name: "沙鹿区" },
        { code: "710446", name: "龙井区" },
        { code: "710447", name: "梧栖区" },
        { code: "710448", name: "清水区" },
        { code: "710449", name: "大甲区" },
        { code: "710450", name: "外埔区" },
        { code: "710451", name: "大安区" }
      ]
    },
    {
      code: "710500",
      name: "金门县",
      districts: [
        { code: "710507", name: "金沙镇" },
        { code: "710508", name: "金湖镇" },
        { code: "710509", name: "金宁乡" },
        { code: "710510", name: "金城镇" },
        { code: "710511", name: "烈屿乡" },
        { code: "710512", name: "乌丘乡" }
      ]
    },
    {
      code: "710600",
      name: "南投县",
      districts: [
        { code: "710614", name: "南投市" },
        { code: "710615", name: "中寮乡" },
        { code: "710616", name: "草屯镇" },
        { code: "710617", name: "国姓乡" },
        { code: "710618", name: "埔里镇" },
        { code: "710619", name: "仁爱乡" },
        { code: "710620", name: "名间乡" },
        { code: "710621", name: "集集镇" },
        { code: "710622", name: "水里乡" },
        { code: "710623", name: "鱼池乡" },
        { code: "710624", name: "信义乡" },
        { code: "710625", name: "竹山镇" },
        { code: "710626", name: "鹿谷乡" }
      ]
    },
    {
      code: "710700",
    ...
    },
    {
      ...
      name: "新北市",
      districts: [
        { code: "711130", name: "万里区" },
        { code: "711131", name: "金山区" },
        { code: "711132", name: "板桥区" },
        { code: "711133", name: "汐止区" },
        { code: "711134", name: "深坑区" },
        { code: "711135", name: "石碇区" },
        { code: "711136", name: "瑞芳区" },
        { code: "711137", name: "平溪区" },
        { code: "711138", name: "双溪区" },
        { code: "711139", name: "贡寮区" },
        { code: "711140", name: "新店区" },
        { code: "711141", name: "坪林区" },
        { code: "711142", name: "乌来区" },
        { code: "711143", name: "永和区" },
        { code: "711144", name: "中和区" },
        { code: "711145", name: "土城区" },
        { code: "711146", name: "三峡区" },
        { code: "711147", name: "树林区" },
        { code: "711148", name: "莺歌区" },
        { code: "711149", name: "三重区" },
        { code: "711150", name: "新庄区" },
        { code: "711151", name: "泰山区" },
        { code: "711152", name: "林口区" },
        { code: "711153", name: "芦洲区" },
        { code: "711154", name: "五股区" },
        { code: "711155", name: "八里区" },
        { code: "711156", name: "淡水区" },
        { code: "711157", name: "三芝区" },
        { code: "711158", name: "石门区" }
      ]
    },
    {
      code: "711200",
      name: "宜兰县",
      districts: [
        { code: "711214", name: "宜兰市" },
        { code: "711215", name: "头城镇" },
        { code: "711216", name: "礁溪乡" },
        { code: "711217", name: "壮围乡" },
        { code: "711218", name: "员山乡" },
        { code: "711219", name: "罗东镇" },
        { code: "711220", name: "三星乡" },
        { code: "711221", name: "大同乡" },
        { code: "711222", name: "五结乡" },
        { code: "711223", name: "冬山乡" },
        { code: "711224", name: "苏澳镇" },
        { code: "711225", name: "南澳乡" }
      ]
    },
    {
      code: "711300",
      name: "新竹县",
      districts: [
        { code: "711314", name: "竹北市" },
        { code: "711315", name: "湖口乡" },
        { code: "711316", name: "新丰乡" },
        { code: "711317", name: "新埔镇" },
        { code: "711318", name: "关西镇" },
        { code: "711319", name: "芎林乡" },
        { code: "711320", name: "宝山乡" },
        { code: "711321", name: "竹东镇" },
        { code: "711322", name: "五峰乡" },
        { code: "711323", name: "横山乡" },
        { code: "711324", name: "尖石乡" },
        { code: "711325", name: "北埔乡" },
        { code: "711326", name: "峨眉乡" }
      ]
    },
    {
      code: "711400",
      name: "桃园市",
      districts: [
        { code: "711414", name: "中坜区" },
        { code: "711415", name: "平镇区" },
        { code: "711416", name: "龙潭区" },
        { code: "711417", name: "杨梅区" },
        { code: "711418", name: "新屋区" },
        { code: "711419", name: "观音区" },
        { code: "711420", name: "桃园区" },
        { code: "711421", name: "龟山区" },
        { code: "711422", name: "八德区" },
        { code: "711423", name: "大溪区" },
        { code: "711424", name: "复兴区" },
        { code: "711425", name: "大园区" },
        { code: "711426", name: "芦竹区" }
      ]
    },
    {
      code: "711500",
      name: "苗栗县",
      districts: [
        { code: "711519", name: "竹南镇" },
        { code: "711520", name: "头份市" },
        { code: "711521", name: "三湾乡" },
        { code: "711522", name: "南庄乡" },
        { code: "711523", name: "狮潭乡" },
        { code: "711524", name: "后龙镇" },
        { code: "711525", name: "通霄镇" },
        { code: "711526", name: "苑里镇" },
        { code: "711527", name: "苗栗市" },
        { code: "711528", name: "造桥乡" },
        { code: "711529", name: "头屋乡" },
        { code: "711530", name: "公馆乡" },
        { code: "711531", name: "大湖乡" },
        { code: "711532", name: "泰安乡" },
        { code: "711533", name: "铜锣乡" },
        { code: "711534", name: "三义乡" },
        { code: "711535", name: "西湖乡" },
        { code: "711536", name: "卓兰镇" }
      ]
    },
    {
      code: "711700",
      name: "彰化县",
      districts: [
        { code: "711727", name: "彰化市" },
        { code: "711728", name: "芬园乡" },
        { code: "711729", name: "花坛乡" },
        { code: "711730", name: "秀水乡" },
        { code: "711731", name: "鹿港镇" },
        { code: "711732", name: "福兴乡" },
        { code: "711733", name: "线西乡" },
        { code: "711734", name: "和美镇" },
        { code: "711735", name: "伸港乡" },
        { code: "711736", name: "员林市" },
        { code: "711737", name: "社头乡" },
        { code: "711738", name: "永靖乡" },
        { code: "711739", name: "埔心乡" },
        { code: "711740", name: "溪湖镇" },
        { code: "711741", name: "大村乡" },
        { code: "711742", name: "埔盐乡" },
        { code: "711743", name: "田中镇" },
        { code: "711744", name: "北斗镇" },
        { code: "711745", name: "田尾乡" },
        { code: "711746", name: "埤头乡" },
        { code: "711747", name: "溪州乡" },
        { code: "711748", name: "竹塘乡" },
        { code: "711749", name: "二林镇" },
        { code: "711750", name: "大城乡" },
        { code: "711751", name: "芳苑乡" },
        { code: "711752", name: "二水乡" }
      ]
    },
    {
      code: "711900",
      name: "嘉义县",
      districts: [
        { code: "711919", name: "番路乡" },
        { code: "711920", name: "梅山乡" },
        { code: "711921", name: "竹崎乡" },
        { code: "711922", name: "阿里山乡" },
        { code: "711923", name: "中埔乡" },
        { code: "711924", name: "大埔乡" },
        { code: "711925", name: "水上乡" },
        { code: "711926", name: "鹿草乡" },
        { code: "711927", name: "太保市" },
        { code: "711928", name: "朴子市" },
        { code: "711929", name: "东石乡" },
        { code: "711930", name: "六脚乡" },
        { code: "711931", name: "新港乡" },
        { code: "711932", name: "民雄乡" },
        { code: "711933", name: "大林镇" },
        { code: "711934", name: "溪口乡" },
        { code: "711935", name: "义竹乡" },
        { code: "711936", name: "布袋镇" }
      ]
    },
    {
      code: "712100",
      name: "云林县",
      districts: [
        { code: "712121", name: "斗南镇" },
        { code: "712122", name: "大埤乡" },
        { code: "712123", name: "虎尾镇" },
        { code: "712124", name: "土库镇" },
        { code: "712125", name: "褒忠乡" },
        { code: "712126", name: "东势乡" },
        { code: "712127", name: "台西乡" },
        { code: "712128", name: "仑背乡" },
        { code: "712129", name: "麦寮乡" },
        { code: "712130", name: "斗六市" },
        { code: "712131", name: "林内乡" },
        { code: "712132", name: "古坑乡" },
        { code: "712133", name: "莿桐乡" },
        { code: "712134", name: "西螺镇" },
        { code: "712135", name: "二仑乡" },
        { code: "712136", name: "北港镇" },
        { code: "712137", name: "水林乡" },
        { code: "712138", name: "口湖乡" },
        { code: "712139", name: "四湖乡" },
        { code: "712140", name: "元长乡" }
      ]
    },
    {
      code: "712400",
      name: "屏东县",
      districts: [
        { code: "712434", name: "屏东市" },
        { code: "712435", name: "三地门乡" },
        { code: "712436", name: "雾台乡" },
        { code: "712437", name: "玛家乡" },
        { code: "712438", name: "九如乡" },
        { code: "712439", name: "里港乡" },
        { code: "712440", name: "高树乡" },
        { code: "712441", name: "盐埔乡" },
        { code: "712442", name: "长治乡" },
        { code: "712443", name: "麟洛乡" },
        { code: "712444", name: "竹田乡" },
        { code: "712445", name: "内埔乡" },
        { code: "712446", name: "万丹乡" },
        { code: "712447", name: "潮州镇" },
        { code: "712448", name: "泰武乡" },
        { code: "712449", name: "来义乡" },
        { code: "712450", name: "万峦乡" },
        { code: "712451", name: "崁顶乡" },
        { code: "712452", name: "新埤乡" },
        { code: "712453", name: "南州乡" },
        { code: "712454", name: "林边乡" },
        { code: "712455", name: "东港镇" },
        { code: "712456", name: "琉球乡" },
        { code: "712457", name: "佳冬乡" },
        { code: "712458", name: "新园乡" },
        { code: "712459", name: "枋寮乡" },
        { code: "712460", name: "枋山乡" },
        { code: "712461", name: "春日乡" },
        { code: "712462", name: "狮子乡" },
        { code: "712463", name: "车城乡" },
        { code: "712464", name: "牡丹乡" },
        { code: "712465", name: "恒春镇" },
        { code: "712466", name: "满州乡" }
      ]
    },
    {
      code: "712500",
      name: "台东县",
      districts: [
        { code: "712517", name: "台东市" },
        { code: "712518", name: "绿岛乡" },
        { code: "712519", name: "兰屿乡" },
        { code: "712520", name: "延平乡" },
        { code: "712521", name: "卑南乡" },
        { code: "712522", name: "鹿野乡" },
        { code: "712523", name: "关山镇" },
        { code: "712524", name: "海端乡" },
        { code: "712525", name: "池上乡" },
        { code: "712526", name: "东河乡" },
        { code: "712527", name: "成功镇" },
        { code: "712528", name: "长滨乡" },
        { code: "712529", name: "太麻里乡" },
        { code: "712530", name: "金峰乡" },
        { code: "712531", name: "大武乡" },
        { code: "712532", name: "达仁乡" }
      ]
    },
    {
      code: "712600",
      name: "花莲县",
      districts: [
        { code: "712615", name: "花莲市" },
        { code: "712616", name: "新城乡" },
        { code: "712617", name: "秀林乡" },
        { code: "712618", name: "吉安乡" },
        { code: "712619", name: "寿丰乡" },
        { code: "712620", name: "凤林镇" },
        { code: "712621", name: "光复乡" },
        { code: "712622", name: "丰滨乡" },
        { code: "712623", name: "瑞穗乡" },
        { code: "712624", name: "万荣乡" },
        { code: "712625", name: "玉里镇" },
        { code: "712626", name: "卓溪乡" },
        { code: "712627", name: "富里乡" }
      ]
    },
    {
      code: "712700",
      name: "澎湖县",
      districts: [
        { code: "712707", name: "马公市" },
        { code: "712708", name: "西屿乡" },
        { code: "712709", name: "望安乡" },
        { code: "712710", name: "七美乡" },
        { code: "712711", name: "白沙乡" },
        { code: "712712", name: "湖西乡" }
      ]
    },
    {
      code: "712800",
      name: "连江县",
      districts: [
        { code: "712805", name: "南竿乡" },
        { code: "712806", name: "北竿乡" },
        { code: "712807", name: "莒光乡" },
        { code: "712808", name: "东引乡" }
      ]
    }
  ]
};
// 香港特别行政区
export const xianggang: Province = {
  code: "810000",
  name: "香港特别行政区",
  cities: [
    {
    ...
    },
    {
      ...
      districts: [
        ...
        { code: "810306", name: "西贡区" },
        { code: "810307", name: "沙田区" },
